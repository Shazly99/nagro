          ...
          <Row>
            ...
            <Col xl={6} lg={6} md={6} sm={12} className='app_footer_location px-5'>
              ...
              <div className="address_footer mt-4" >
                ...
                <div className="item">
                  <p className='flex gap-2 align-items-center'>  <strong> مكة المكرمة :  </strong>  <span>حي الحمراء و ام الجود، طريق مكة جدة السريع</span> </p>
                  <p className='flex gap-2 align-items-center'>  <strong>    جدة :  </strong>  <span>حي الحمراء و ام الجود، طريق مكة جدة السريع</span> </p>
                 </div>
              </div>
            </Col>
