      ...
      <Container>
        <Row>
          <Col xl={6} lg={6} md={12} sm={12} dir={isLang === "en" ? 'ltr' : 'rtl'}>
            <span className='w-100 client_span'>ابقي علي تواصل</span>
            <Form className="form" onSubmit={formik.handleSubmit} >
              <Row className='mt-6'> 
                <Col xl={6} lg={6} md={6} sm={12}>
                  <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                    <Form.Label className='label-style'>  الاسم  </Form.Label>
                    <Form.Control
                      name="name"
                      ...
                      className='input-style' type="text" placeholder={'ادخل الاسم'} />
                ...
                <Col xl={6} lg={6} md={6} sm={12}>
                  ...
                  <Form.Group className="mb-3" controlId="exampleForm.ControlInput2">
                    <Form.Label className='label-style'>  بريد الالكتروني </Form.Label>
                    <Form.Control
                      name="email"
                      ...
                      className='input-style' type="email" placeholder="email" />
                ...
                <Col xl={6} lg={6} md={6} sm={12}>
                  <Form.Group className="mb-3" controlId="exampleForm.ControlInput3">
                    <Form.Label className='label-style'>رقم الجوال</Form.Label>
                    <Form.Control
                      name="phone"
                ...
                <Col xl={6} lg={6} md={6} sm={12}>
                  <Form.Group className="mb-3" controlId="exampleForm.ControlInput4">
                    <Form.Label className='label-style'> سبب</Form.Label>
                    <Form.Control
                      name="reason"
                      ...
                      className='input-style' type="text" placeholder="reason" />
                ...
                <Col xl={12} lg={12} md={12} sm={12}>
                  <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea5">
                    <Form.Label className='label-style'>اترك رسالتك</Form.Label>
                    <Form.Control
                      name="message"
                      ...
                      className='input-style' as="textarea" rows={5} placeholder="message" />
              ...
              <Button size='small' iconPos={isLang === "en" ? "left" : 'right'} icon="pi pi-arrow-left" type="submit" label='إرسال' className='rounded-2 mt-4 p-2 px-4' />
            </Form>
